...
std::vector<int> CNN_vggnetFluid_E::inference() {

  std::cout << "CNN_vggnetFluid_E::inference" << std::endl;
  ...
  Data *d_conv2d_0 = new Data;
  d_conv2d_0->set_data((void*)conv2d_0);
  Data *d_conv2d_1 = new Data;
  d_conv2d_1->set_data((void*)conv2d_1);
  Data *d_conv2d_2 = new Data;
  d_conv2d_2->set_data((void*)conv2d_2);
  Data *d_conv2d_3 = new Data;
  d_conv2d_3->set_data((void*)conv2d_3);
  Data *d_conv2d_4 = new Data;
  d_conv2d_4->set_data((void*)conv2d_4);
  Data *d_conv2d_5 = new Data;
  d_conv2d_5->set_data((void*)conv2d_5);
  Data *d_conv2d_6 = new Data;
  d_conv2d_6->set_data((void*)conv2d_6);
  Data *d_conv2d_7 = new Data;
  d_conv2d_7->set_data((void*)conv2d_7);
  Data *d_conv2d_8 = new Data;
  d_conv2d_8->set_data((void*)conv2d_8);
  Data *d_conv2d_9 = new Data;
  d_conv2d_9->set_data((void*)conv2d_9);
  Data *d_conv2d_10 = new Data;
  d_conv2d_10->set_data((void*)conv2d_10);
  Data *d_conv2d_11 = new Data;
  d_conv2d_11->set_data((void*)conv2d_11);
  Data *d_conv2d_12 = new Data;
  d_conv2d_12->set_data((void*)conv2d_12);
  ...
  Data *d_max_pooling2d_0 = new Data;
  d_max_pooling2d_0->set_data((void*)max_pooling2d_0);
  Data *d_max_pooling2d_1 = new Data;
  d_max_pooling2d_1->set_data((void*)max_pooling2d_1);
  Data *d_max_pooling2d_2 = new Data;
  d_max_pooling2d_2->set_data((void*)max_pooling2d_2);
  Data *d_max_pooling2d_3 = new Data;
  d_max_pooling2d_3->set_data((void*)max_pooling2d_3);
  Data *d_max_pooling2d_4 = new Data;
  d_max_pooling2d_4->set_data((void*)max_pooling2d_4);
  ...
  int tot = 0;
  ////#pragma call_num call_num_conv2d_0;
  auto call_num_conv2d_0 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g1,{},{},{d_input},{d_conv2d_0}>>>CNN_vggnetFluid_E::convolution_layer_E(input, conv2d_0, all_weights_list[tot++], 1.0, call_num_conv2d_1->p);
  auto tpb__g1 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, input, conv2d_0, all_weights_list[tot++], 1.0, call_num_conv2d_0->p);
  auto tp__g1 = tf->newTask<decltype(tpb__g1)>("conv_layer" + std::to_string(tot-1), {d_input}, {d_conv2d_0}, tpb__g1);
  Guard* g1 = gs->newGuard("conv_layer" + std::to_string(tot-1), {}, {}, tp__g1, {});
  //guard_log.push_back(g1);
  ////#pragma valve v_conv2d_1 = v1.init(call_num_conv2d_1, conv2d_1->c*1);
  auto v_conv2d_0 = v1.init(call_num_conv2d_0, conv2d_0->c*rate);
  ////g1->set_root;
  g1->set_root();
  ...
  ////#pragma call_num call_num_conv2d_1;
  auto call_num_conv2d_1 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g2,{},{},{d_conv2d_0},{d_conv2d_1}>>>CNN_vggnetFluid_E::convolution_layer_E(conv2d_0, conv2d_1, all_weights_list[tot++], 1.0, call_num_conv2d_1->p);
  auto tpb__g2 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, conv2d_0, conv2d_1, all_weights_list[tot++], 1.0/rate, call_num_conv2d_1->p);
  auto tp__g2 = tf->newTask<decltype(tpb__g2)>("conv_layer" + std::to_string(tot-1), {d_conv2d_0}, {d_conv2d_1}, tpb__g2);
  Guard* g2 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_conv2d_0}, {}, tp__g2, {});
  //guard_log.push_back(g2);
  ////#pragma valve v_conv2d_1 = v1.init(call_num_conv2d_1, conv2d_1->c*1);
  auto v_conv2d_1 = v1.init(call_num_conv2d_1, conv2d_1->c*rate);


  ////#pragma call_num call_num_max_pooling2d_0;
  auto call_num_max_pooling2d_0 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g3,{v_conv2d_1},{},{d_conv2d_1},{d_max_pooling2d_0}>>>CNN_vggnetFluid_E::maxpool_layer_E(conv2d_1, max_pooling2d_0, 2, 2, call_num_max_pooling2d_0->p);
  auto tpb__g3 = std::bind(&CNN_vggnetFluid_E::maxpool_layer_E, this, conv2d_1, max_pooling2d_0, 2, 2, call_num_max_pooling2d_0->p);
  auto tp__g3 = tf->newTask<decltype(tpb__g3)>("maxpool_layer" + std::to_string(0), {d_conv2d_1}, {d_max_pooling2d_0}, tpb__g3);
  Guard* g3 = gs->newGuard("maxpool_layer" + std::to_string(0), {v_conv2d_1}, {}, tp__g3, {});
  //guard_log.push_back(g3);
  ////#pragma valve v_max_pooling2d_0 = v1.init(call_num_max_pooling2d_0, 1);
  auto v_max_pooling2d_0 = v1.init(call_num_max_pooling2d_0, 1);


  ////#pragma call_num call_num_conv2d_2;
  auto call_num_conv2d_2 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g4,{v_max_pooling2d_0},{},{d_max_pooling2d_0},{d_conv2d_2}>>>CNN_vggnetFluid_E::convolution_layer_E(max_pooling2d_0, conv2d_2, all_weights_list[tot++], 1.0, call_num_conv2d_2->p);
  auto tpb__g4 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, max_pooling2d_0, conv2d_2, all_weights_list[tot++], 1.0/rate, call_num_conv2d_2->p);
  auto tp__g4 = tf->newTask<decltype(tpb__g4)>("conv_layer" + std::to_string(tot-1), {d_max_pooling2d_0}, {d_conv2d_2}, tpb__g4);
  Guard* g4 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_max_pooling2d_0}, {}, tp__g4, {});
  //guard_log.push_back(g4);
  ////#pragma valve v_conv2d_2 = v1.init(call_num_conv2d_2, conv2d_2->c*rate);
  auto v_conv2d_2 = v1.init(call_num_conv2d_2, conv2d_2->c*rate);


  ////#pragma call_num call_num_conv2d_3;
  auto call_num_conv2d_3 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g5,{v_conv2d_2},{},{d_conv2d_2},{d_conv2d_3}>>>CNN_vggnetFluid_E::convolution_layer_E(conv2d_2, conv2d_3, all_weights_list[tot++], 1.0/rate, call_num_conv2d_3->p);
  auto tpb__g5 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, conv2d_2, conv2d_3, all_weights_list[tot++], 1.0/rate, call_num_conv2d_3->p);
  auto tp__g5 = tf->newTask<decltype(tpb__g5)>("conv_layer" + std::to_string(tot-1), {d_conv2d_2}, {d_conv2d_3}, tpb__g5);
  Guard* g5 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_conv2d_2}, {}, tp__g5, {});
  //guard_log.push_back(g5);
  ////#pragma valve v_conv2d_1 = v1.init(call_num_conv2d_1, conv2d_1->c*rate);
  auto v_conv2d_3 = v1.init(call_num_conv2d_3, conv2d_3->c*rate);


  ////#pragma call_num call_num_max_pooling2d_1;
  auto call_num_max_pooling2d_1 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g6,{v_conv2d_3},{},{d_conv2d_3},{d_max_pooling2d_1}>>>CNN_vggnetFluid_E::maxpool_layer_E(conv2d_3, max_pooling2d_1, 2, 2, call_num_max_pooling2d_1->p);
  auto tpb__g6 = std::bind(&CNN_vggnetFluid_E::maxpool_layer_E, this, conv2d_3, max_pooling2d_1, 2, 2, call_num_max_pooling2d_1->p);
  auto tp__g6 = tf->newTask<decltype(tpb__g6)>("maxpool_layer" + std::to_string(0), {d_conv2d_3}, {d_max_pooling2d_1}, tpb__g6);
  Guard* g6 = gs->newGuard("maxpool_layer" + std::to_string(0), {v_conv2d_3}, {}, tp__g6, {});
  //guard_log.push_back(g6);
  ////#pragma valve v_max_pooling2d_1 = v1.init(call_num_max_pooling2d_1, 1);
  auto v_max_pooling2d_1 = v1.init(call_num_max_pooling2d_1, 1);


  ////#pragma call_num call_num_conv2d_4;
  auto call_num_conv2d_4 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g7,{v_max_pooling2d_1},{},{d_max_pooling2d_1},{d_conv2d_4}>>>CNN_vggnetFluid_E::convolution_layer_E(max_pooling2d_1, conv2d_4, all_weights_list[tot++], 1.0/rate, call_num_conv2d_4->p);
  auto tpb__g7 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, max_pooling2d_1, conv2d_4, all_weights_list[tot++], 1.0/rate, call_num_conv2d_4->p);
  auto tp__g7 = tf->newTask<decltype(tpb__g7)>("conv_layer" + std::to_string(tot-1), {d_max_pooling2d_1}, {d_conv2d_4}, tpb__g7);
  Guard* g7 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_max_pooling2d_1}, {}, tp__g7, {});
  //guard_log.push_back(g7);
  ////#pragma valve v_conv2d_4 = v1.init(call_num_conv2d_4, conv2d_4->c*rate);
  auto v_conv2d_4 = v1.init(call_num_conv2d_4, conv2d_4->c*rate);


  ////#pragma call_num call_num_conv2d_5;
  auto call_num_conv2d_5 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g8,{v_conv2d_4},{},{d_conv2d_4},{d_conv2d_5}>>>CNN_vggnetFluid_E::convolution_layer_E(conv2d_4, conv2d_5, all_weights_list[tot++], 1.0/rate, call_num_conv2d_5->p);
  auto tpb__g8 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, conv2d_4, conv2d_5, all_weights_list[tot++], 1.0/rate, call_num_conv2d_5->p);
  auto tp__g8 = tf->newTask<decltype(tpb__g8)>("conv_layer" + std::to_string(tot-1), {d_conv2d_4}, {d_conv2d_5}, tpb__g8);
  Guard* g8 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_conv2d_4}, {}, tp__g8, {});
  //guard_log.push_back(g8);
  ////#pragma valve v_conv2d_5 = v1.init(call_num_conv2d_5, conv2d_5->c*rate);
  auto v_conv2d_5 = v1.init(call_num_conv2d_5, conv2d_5->c*rate);


  ////#pragma call_num call_num_conv2d_6;
  auto call_num_conv2d_6 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g9,{v_conv2d_5},{},{d_conv2d_5},{d_conv2d_6}>>>CNN_vggnetFluid_E::convolution_layer_E(conv2d_5, conv2d_6, all_weights_list[tot++], 1.0/rate, call_num_conv2d_6->p);
  auto tpb__g9 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, conv2d_5, conv2d_6, all_weights_list[tot++], 1.0/rate, call_num_conv2d_6->p);
  auto tp__g9 = tf->newTask<decltype(tpb__g9)>("conv_layer" + std::to_string(tot-1), {d_conv2d_5}, {d_conv2d_6}, tpb__g9);
  Guard* g9 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_conv2d_5}, {}, tp__g9, {});
  //guard_log.push_back(g9);
  ////#pragma valve v_conv2d_6 = v1.init(call_num_conv2d_6, conv2d_6->c*rate);
  auto v_conv2d_6 = v1.init(call_num_conv2d_6, conv2d_6->c*rate);


  ////#pragma call_num call_num_max_pooling2d_2;
  auto call_num_max_pooling2d_2 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g10,{v_conv2d_6},{},{d_conv2d_6},{d_max_pooling2d_2}>>>CNN_vggnetFluid_E::maxpool_layer_E(conv2d_6, max_pooling2d_2, 2, 2, call_num_max_pooling2d_2->p);
  auto tpb__g10 = std::bind(&CNN_vggnetFluid_E::maxpool_layer_E, this, conv2d_6, max_pooling2d_2, 2, 2, call_num_max_pooling2d_2->p);
  auto tp__g10 = tf->newTask<decltype(tpb__g10)>("maxpool_layer" + std::to_string(0), {d_conv2d_6}, {d_max_pooling2d_2}, tpb__g10);
  Guard* g10 = gs->newGuard("maxpool_layer" + std::to_string(0), {v_conv2d_6}, {}, tp__g10, {});
  //guard_log.push_back(g10);
  ////#pragma valve v_max_pooling2d_2 = v1.init(call_num_max_pooling2d_2, 1);
  auto v_max_pooling2d_2 = v1.init(call_num_max_pooling2d_2, 1);


  ////#pragma call_num call_num_conv2d_7;
  auto call_num_conv2d_7 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g11,{v_max_pooling2d_2},{},{d_max_pooling2d_2},{d_conv2d_7}>>>CNN_vggnetFluid_E::convolution_layer_E(max_pooling2d_2, conv2d_7, all_weights_list[tot++], 1.0/rate, call_num_conv2d_7->p);
  auto tpb__g11 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, max_pooling2d_2, conv2d_7, all_weights_list[tot++], 1.0/rate, call_num_conv2d_7->p);
  auto tp__g11 = tf->newTask<decltype(tpb__g11)>("conv_layer" + std::to_string(tot-1), {d_max_pooling2d_2}, {d_conv2d_7}, tpb__g11);
  Guard* g11 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_max_pooling2d_2}, {}, tp__g11, {});
  //guard_log.push_back(g11);
  ////#pragma valve v_conv2d_7 = v1.init(call_num_conv2d_7, conv2d_7->c*rate);
  auto v_conv2d_7 = v1.init(call_num_conv2d_7, conv2d_7->c*rate);


  ////#pragma call_num call_num_conv2d_8;
  auto call_num_conv2d_8 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g12,{v_conv2d_7},{},{d_conv2d_7},{d_conv2d_8}>>>CNN_vggnetFluid_E::convolution_layer_E(conv2d_7, conv2d_8, all_weights_list[tot++], 1.0/rate, call_num_conv2d_8->p);
  auto tpb__g12 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, conv2d_7, conv2d_8, all_weights_list[tot++], 1.0/rate, call_num_conv2d_8->p);
  auto tp__g12 = tf->newTask<decltype(tpb__g12)>("conv_layer" + std::to_string(tot-1), {d_conv2d_7}, {d_conv2d_8}, tpb__g12);
  Guard* g12 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_conv2d_7}, {}, tp__g12, {});
  //guard_log.push_back(g12);
  ////#pragma valve v_conv2d_8 = v1.init(call_num_conv2d_8, conv2d_8->c*rate);
  auto v_conv2d_8 = v1.init(call_num_conv2d_8, conv2d_8->c*rate);


  ////#pragma call_num call_num_conv2d_9;
  auto call_num_conv2d_9 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g13,{v_conv2d_8},{},{d_conv2d_8},{d_conv2d_9}>>>CNN_vggnetFluid_E::convolution_layer_E(conv2d_8, conv2d_9, all_weights_list[tot++], 1.0/rate, call_num_conv2d_9->p);
  auto tpb__g13 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, conv2d_8, conv2d_9, all_weights_list[tot++], 1.0/rate, call_num_conv2d_9->p);
  auto tp__g13 = tf->newTask<decltype(tpb__g13)>("conv_layer" + std::to_string(tot-1), {d_conv2d_8}, {d_conv2d_9}, tpb__g13);
  Guard* g13 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_conv2d_8}, {}, tp__g13, {});
  //guard_log.push_back(g13);
  ////#pragma valve v_conv2d_9 = v1.init(call_num_conv2d_9, conv2d_9->c*rate);
  auto v_conv2d_9 = v1.init(call_num_conv2d_9, conv2d_9->c*rate);


  ////#pragma call_num call_num_max_pooling2d_3;
  auto call_num_max_pooling2d_3 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g14,{v_conv2d_9},{},{d_conv2d_9},{d_max_pooling2d_3}>>>CNN_vggnetFluid_E::maxpool_layer_E(conv2d_9, max_pooling2d_3, 2, 2, call_num_max_pooling2d_3->p);
  auto tpb__g14 = std::bind(&CNN_vggnetFluid_E::maxpool_layer_E, this, conv2d_9, max_pooling2d_3, 2, 2, call_num_max_pooling2d_3->p);
  auto tp__g14 = tf->newTask<decltype(tpb__g14)>("maxpool_layer" + std::to_string(0), {d_conv2d_9}, {d_max_pooling2d_3}, tpb__g14);
  Guard* g14 = gs->newGuard("maxpool_layer" + std::to_string(0), {v_conv2d_9}, {}, tp__g14, {});
  //guard_log.push_back(g14);
  ////#pragma valve v_max_pooling2d_3 = v1.init(call_num_max_pooling2d_3, 1);
  auto v_max_pooling2d_3 = v1.init(call_num_max_pooling2d_3, 1);


  ////#pragma call_num call_num_conv2d_10;
  auto call_num_conv2d_10 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g15,{v_max_pooling2d_3},{},{d_max_pooling2d_3},{d_conv2d_10}>>>CNN_vggnetFluid_E::convolution_layer_E(max_pooling2d_3, conv2d_10, all_weights_list[tot++], 1.0/rate, call_num_conv2d_10->p);
  auto tpb__g15 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, max_pooling2d_3, conv2d_10, all_weights_list[tot++], 1.0/rate, call_num_conv2d_10->p);
  auto tp__g15 = tf->newTask<decltype(tpb__g15)>("conv_layer" + std::to_string(tot-1), {d_max_pooling2d_3}, {d_conv2d_10}, tpb__g15);
  Guard* g15 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_max_pooling2d_3}, {}, tp__g15, {});
  //guard_log.push_back(g15);
  ////#pragma valve v_conv2d_10 = v1.init(call_num_conv2d_10, conv2d_10->c*rate);
  auto v_conv2d_10 = v1.init(call_num_conv2d_10, conv2d_10->c*rate);


  ////#pragma call_num call_num_conv2d_11;
  auto call_num_conv2d_11 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g16,{v_conv2d_10},{},{d_conv2d_10},{d_conv2d_11}>>>CNN_vggnetFluid_E::convolution_layer_E(conv2d_10, conv2d_11, all_weights_list[tot++], 1.0/rate, call_num_conv2d_11->p);
  auto tpb__g16 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, conv2d_10, conv2d_11, all_weights_list[tot++], 1.0/rate, call_num_conv2d_11->p);
  auto tp__g16 = tf->newTask<decltype(tpb__g16)>("conv_layer" + std::to_string(tot-1), {d_conv2d_10}, {d_conv2d_11}, tpb__g16);
  Guard* g16 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_conv2d_10}, {}, tp__g16, {});
  //guard_log.push_back(g16);
  ////#pragma valve v_conv2d_11 = v1.init(call_num_conv2d_11, conv2d_11->c*rate);
  auto v_conv2d_11 = v1.init(call_num_conv2d_11, conv2d_11->c*rate);


  ////#pragma call_num call_num_conv2d_12;
  auto call_num_conv2d_12 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g17,{v_conv2d_11},{},{d_conv2d_11},{d_conv2d_12}>>>CNN_vggnetFluid_E::convolution_layer_E(conv2d_11, conv2d_12, all_weights_list[tot++], 1.0/rate, call_num_conv2d_12->p);
  auto tpb__g17 = std::bind(&CNN_vggnetFluid_E::convolution_layer_E, this, conv2d_11, conv2d_12, all_weights_list[tot++], 1.0/rate, call_num_conv2d_12->p);
  auto tp__g17 = tf->newTask<decltype(tpb__g17)>("conv_layer" + std::to_string(tot-1), {d_conv2d_11}, {d_conv2d_12}, tpb__g17);
  Guard* g17 = gs->newGuard("conv_layer" + std::to_string(tot-1), {v_conv2d_11}, {}, tp__g17, {});
  //guard_log.push_back(g17);
  ////#pragma valve v_conv2d_12 = v1.init(call_num_conv2d_12, conv2d_12->c*rate);
  auto v_conv2d_12 = v1.init(call_num_conv2d_12, conv2d_12->c*rate);


  ////#pragma call_num call_num_max_pooling2d_4;
  auto call_num_max_pooling2d_4 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g18,{v_conv2d_12},{},{d_conv2d_12},{d_max_pooling2d_4}>>>CNN_vggnetFluid_E::maxpool_layer_E(conv2d_12, max_pooling2d_4, 2, 2, call_num_max_pooling2d_4->p);
  auto tpb__g18 = std::bind(&CNN_vggnetFluid_E::maxpool_layer_E, this, conv2d_12, max_pooling2d_4, 2, 2, call_num_max_pooling2d_4->p);
  auto tp__g18 = tf->newTask<decltype(tpb__g18)>("maxpool_layer" + std::to_string(0), {d_conv2d_12}, {d_max_pooling2d_4}, tpb__g18);
  Guard* g18 = gs->newGuard("maxpool_layer" + std::to_string(0), {v_conv2d_12}, {}, tp__g18, {});
  //guard_log.push_back(g18);
  ////#pragma valve v_max_pooling2d_4 = v1.init(call_num_max_pooling2d_4, 1);
  auto v_max_pooling2d_4 = v1.init(call_num_max_pooling2d_4, 1);


  ////#pragma call_num call_num_flatten_;
  auto call_num_flatten_ = new __fluid__<int>(new int(0));
  ////#pragma task <<<g19,{v_max_pooling2d_4},{},{d_max_pooling2d_4},{d_flatten_}>>>CNN_vggnetFluid_E::flatten_E(max_pooling2d_4, flatten_, call_num_flatten_->p);
  auto tpb__g19 = std::bind(&CNN_vggnetFluid_E::flatten_E, this, max_pooling2d_4, flatten_, call_num_flatten_->p);
  auto tp__g19 = tf->newTask<decltype(tpb__g19)>("flatten" + std::to_string(0), {d_max_pooling2d_4}, {d_flatten_}, tpb__g19);
  Guard* g19 = gs->newGuard("flatten" + std::to_string(0), {v_max_pooling2d_4}, {}, tp__g19, {});
  ...
  ////#pragma call_num call_num_dense_1;
  auto call_num_dense_1 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g20,{v_flatten_},{},{d_flatten_},{d_dense_1}>>>CNN_vggnetFluid_E::dense_layer_E(flatten_, dense_1, all_weights_list[tot++], 1.0 / rate, call_num_dense_1->p);
  auto tpb__g20 = std::bind(&CNN_vggnetFluid_E::dense_layer_E, this, flatten_, dense_1, all_weights_list[tot++], 1.0/rate, call_num_dense_1->p);
  auto tp__g20 = tf->newTask<decltype(tpb__g20)>("dense_layer" + std::to_string(0), {d_flatten_}, {d_dense_1}, tpb__g20);
  Guard* g20 = gs->newGuard("dense_layer" + std::to_string(0), {v_flatten_}, {}, tp__g20, {});
  //guard_log.push_back(g20);
  ////#pragma valve v_dense_1 = v1.init(call_num_dense_1, 1);
  auto v_dense_1 = v1.init(call_num_dense_1, dense_1->c * rate);


  ////#pragma call_num call_num_activation_1;
  auto call_num_activation_1 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g21,{v_dense_1},{},{d_dense_1},{d_activation_1}>>>CNN_vggnetFluid_E::relu_layer_E(dense_1, activation_1, call_num_activation_1->p);
  auto tpb__g21 = std::bind(&CNN_vggnetFluid_E::relu_layer_E, this, dense_1, activation_1, call_num_activation_1->p);
  auto tp__g21 = tf->newTask<decltype(tpb__g21)>("relu_layer" + std::to_string(2), {d_dense_1}, {d_activation_1}, tpb__g21);
  Guard* g21 = gs->newGuard("relu_layer" + std::to_string(2), {v_dense_1}, {}, tp__g21, {});
  ...
  ////#pragma task <<<g22,{v_activation_1},{},{d_activation_1},{d_dense_2}>>>CNN_vggnetFluid_E::dense_layer_E(activation_1, dense_2, all_weights_list[tot++], 1.0, call_num_dense_2->p);
  auto tpb__g22 = std::bind(&CNN_vggnetFluid_E::dense_layer_E, this, activation_1, dense_2, all_weights_list[tot++], 1.0 / rate, call_num_dense_2->p);
  auto tp__g22 = tf->newTask<decltype(tpb__g22)>("dense_layer" + std::to_string(0), {d_activation_1}, {d_dense_2}, tpb__g22);
  Guard* g22 = gs->newGuard("dense_layer" + std::to_string(0), {v_activation_1}, {}, tp__g22, {});
  //guard_log.push_back(g22);
  ////#pragma valve v_dense_2 = v1.init(call_num_dense_2, 1);
  auto v_dense_2 = v1.init(call_num_dense_2, dense_2->c * 1 - 1);


  ////#pragma call_num call_num_activation_2;
  auto call_num_activation_2 = new __fluid__<int>(new int(0));
  ////#pragma task <<<g23,{v_dense_2},{},{d_dense_2},{d_activation_2}>>>CNN_vggnetFluid_E::relu_layer_E(dense_2, activation_2, call_num_activation_2->p);
  auto tpb__g23 = std::bind(&CNN_vggnetFluid_E::relu_layer_E, this, dense_2, activation_2, call_num_activation_2->p);
  auto tp__g23 = tf->newTask<decltype(tpb__g23)>("relu_layer" + std::to_string(2), {d_dense_2}, {d_activation_2}, tpb__g23);
  Guard* g23 = gs->newGuard("relu_layer" + std::to_string(2), {v_dense_2}, {}, tp__g23, {});
  //guard_log.push_back(g23);
  ////#pragma valve v_activation_2 = v1.init(call_num_activation_2, 1);
  auto v_activation_2 = v1.init(call_num_activation_2, 1);
  ...
  ////#pragma task <<<g24,{v_activation_2},{},{d_activation_2},{d_dense_3}>>>CNN_vggnetFluid_E::dense_layer_E(activation_2, dense_3, all_weights_list[tot++], 1.0, call_num_dense_3->p);
  auto tpb__g24 = std::bind(&CNN_vggnetFluid_E::dense_layer_E, this, activation_2, dense_3, all_weights_list[tot++], 1.0 , call_num_dense_3->p);
  auto tp__g24 = tf->newTask<decltype(tpb__g24)>("dense_layer" + std::to_string(0), {d_activation_2}, {d_dense_3}, tpb__g24);
  Guard* g24 = gs->newGuard("dense_layer" + std::to_string(0), {v_activation_2}, {}, tp__g24, {});
  //guard_log.push_back(g24);
  ////#pragma valve v_dense_3 = v1.init(call_num_dense_3, 1);
  ...
  ////#pragma valve v_activation_3 = v1.init(call_num_activation_3, 1);
  auto v_activation_3 = v1.init(call_num_activation_3, 1);
  ////#pragma task <<<g25,{v_dense_3},{v_activation_3},{d_dense_3},{d_activation_3}>>>CNN_vggnetFluid_E::softmax_layer_E(dense_3, activation_3, call_num_activation_3->p);
  auto tpb__g25 = std::bind(&CNN_vggnetFluid_E::softmax_layer_E, this, dense_3, activation_3, call_num_activation_3->p);
  auto tp__g25 = tf->newTask<decltype(tpb__g25)>("softmax_layer" + std::to_string(0), {d_dense_3}, {d_activation_3}, tpb__g25);
  Guard* g25 = gs->newGuard("softmax_layer" + std::to_string(0), {v_dense_3}, {v_activation_3}, tp__g25, {});
  //guard_log.push_back(g25);
  /////g25->set_leaf();
  g25->set_leaf();
  ...
  for (int n = 0; n < activation_3->n; n++) {
    ...
    for(int i = 0; i < activation_3->size; i++) {
      //std::cout << *activation_3_pixels << std::endl;
