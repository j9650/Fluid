...
void Gaussian_filter_threads1(Sobel_multi *sb, tifImage *image, int num_thread, int thread_id)
{
...
/*
  double sigma_2 = sb->sigma * sb->sigma;
  double sum = 0.0;
  double *kernel = new double[121];
...
void Sobel_filter_threads1(Sobel_multi *sb, tifImage *image, int num_thread, int thread_id)
{
...
void Sobel_multi::segmentImage(tifImage *image)
{
...
////void SobelFluid::Gaussian_filter(tifImage *image)
void Sobel_multi::Gaussian_filter(tifImage *image, int num_thread)
{
...
////void SobelFluid::Sobel_filter(tifImage *image)
void Sobel_multi::Sobel_filter(tifImage *image, int num_thread)
{
