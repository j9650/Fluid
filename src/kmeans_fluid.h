...
namespace example {
	...
	//single thread with end valves
	class KmeansSchemeFluidX_E : public KmeansRandomChangedRecenter {
	public:
		ValveGT<int> v1;
		TaskFactory *ttf;
		AggressiveGS *ggs;
		...
		virtual void segmentImage(RgbImage* image, Clusters* clusters, int n);
		virtual void Recenter(RgbImage* image, Clusters* clusters, double* this_sum);
	};
	//multi thread
	class KmeansSchemeFluidX2_E : public KmeansSchemeFluidX_E {
	public:
		KmeansSchemeFluidX2_E(int _thread_num) {
			thread_num = _thread_num;
		}
		int thread_num;
		ValveGT<int> v1;
	...
	//another multi thread
	class KmeansSchemeFluidX22_E : public KmeansSchemeFluidX_E {
	public:
		KmeansSchemeFluidX22_E(int _thread_num) {
			thread_num = _thread_num;
		}
		int thread_num;
		ValveGT<int> v1;
	...
	//single thread with end valves and stable valve
	class KmeansSchemeFluidXS_E : public KmeansRandomChangedRecenter {
	public:
		ValveGT<int> v1;
		TaskFactory *ttf;
		AggressiveGS *ggs;
